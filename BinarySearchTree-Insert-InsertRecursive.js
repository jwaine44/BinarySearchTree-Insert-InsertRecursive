...
insertRecursive(newVal, current = this.root){
    ...
    else if(current.data < newVal && current.right){
        return this.insertRecursive(newVal, current = current.right);
    }
    else if(current.data > newVal && current.left){
        return this.insertRecursive(newVal, current = current.left);
    }
    return this;
}
